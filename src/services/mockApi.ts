...
let mockBookings: Booking[] = [
  ...
  },
  {
    id: 2,
    event: mockEvents[0],
    user: mockUsers[2], // Мария Петрова
    ticketCount: 1,
    confirmed: true,
  ...
  },
  {
    id: 3,
    event: mockEvents[0],
    user: mockUsers[3], // Алексей Сидоров
    ticketCount: 3,
    confirmed: false,
  ...
  },
  {
    id: 4,
    event: mockEvents[0],
    user: mockUsers[4], // Елена Козлова
    ticketCount: 1,
    confirmed: true,
  ...
  },
  {
    id: 5,
    event: mockEvents[0],
    user: mockUsers[5], // Дмитрий Волков
    ticketCount: 2,
    confirmed: false,
  ...
  },
  {
    id: 6,
    event: mockEvents[0],
    user: mockUsers[6], // Анна Морозова
    ticketCount: 1,
    confirmed: true,
  ...
  },
  {
    id: 7,
    event: mockEvents[0],
    user: mockUsers[7], // Сергей Новиков
    ticketCount: 4,
    confirmed: false,
...
class MockApiService {
  ...
  async getBookings(): Promise<Booking[]> {
    ...
    return mockBookings.filter(b => b.user.email === 'user@example.com');
  }
  ...
  async createBooking(data: CreateBookingRequest): Promise<Booking> {
    ...
    const newBooking: Booking = {
      ...
      event,
      user: mockUsers[0], // Иван Иванов (текущий пользователь)
